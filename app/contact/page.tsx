...
export const metadata: Metadata = {
  title: 'Contact Us',
  description: 'Contact Grand Oak Event Center. We\'d love to hear from you about booking a venue, event planning, or scheduling a tour.',
  keywords: ['Contact Grand Oak Event Center', 'Support', 'Help', 'Get in Touch'],
}
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-8 md:mb-12">
            ...
            <p className="text-base md:text-lg text-gray-600">
              Have questions about booking a venue, event planning, or scheduling a tour? We&#39;d love to hear from you.
            </p>
          </div>
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">events@grandoakeventcenter.com</p>
                    <p className="text-gray-600">support@grandoakeventcenter.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">(555) 123-4506</p>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      2200 Oak Boulevard<br />
                      Lakefront District<br />
                      Chicago, IL 60601
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      ...
                      Saturday - Sunday: By Appointment for Tours
                    </p>
                  </div>
                </div>
              </div>

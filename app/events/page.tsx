...
export const metadata: Metadata = {
  title: 'Events | The Obsidian Hall',
...
async function getData() {
  try {
    ...
    const { data } = await apolloClient.query<EventsData>({ query: GET_EVENTS, variables: { first: 50 }, fetchPolicy: 'cache-first' })
      ...
      <section className="relative py-24 md:py-32">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center pt-16">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-serif font-light text-white mb-6">Events</h1>
            <p className="text-xl text-gray-400 max-w-3xl mx-auto">Browse upcoming and past events.</p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          {items.length === 0 ? (
            <div className="text-center py-12">
              <h2 className="text-2xl font-semibold text-gray-400 mb-2">No Events Yet</h2>
